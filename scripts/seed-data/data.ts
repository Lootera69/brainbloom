...
const seedData: SeedData = {
  ...
  puzzles: [
    ...
    // ========================================================================
    {
      ...
      xpReward: 75,
      cipherData: {
        encodedMessage: "Hjjv jbo hfhkl",
        cipherType: "Caesar Cipher",
        hint: "Shift each letter back by 7.\nCaesar's favorite shift was 3, but this one is different.",
      },
      correctExplanation: "'Hjjv' shifted back by 7 is 'eggs', 'jbo' is 'and', 'hfhkl' is 'bacon'. Simple once you know the key!",
      incorrectExplanation: "Every letter in the message has been shifted forward by a fixed number. Try shifting each letter backward by the same amount to reveal the plaintext.",
    },
    {
      type: "cipher",
      category: "puzzles",
      ...
      xpReward: 100,
      cipherData: {
        encodedMessage: "MNLXTBKZ RZ OMTCM",
        cipherType: "Substitution",
        hint: "Look for common short words — 'RZ' is likely 'is'.\nOnce you know R=I and Z=S, the rest follows.\nM appears twice — could be 'K' or 'N'.",
      },
      correctExplanation: "This is a monoalphabetic substitution cipher. R→I, Z→S, M→K, N→N, L→O, X→W, T→L, B→E, K→D, O→P, C→R. 'MNLXTBKZ RZ OMTCM' = 'KNOWLEDGE IS POWER'.",
    ...
    },
    {
      ...
      question: "A Vigenère cipher uses a keyword. The keyword is 'KEY'. Decode this:",
      correctAnswer: "meet at midnight",
      acceptedAnswers: ["meet at midnight"],
      xpReward: 100,
      cipherData: {
        encodedMessage: "RIJV VN XMVZFMVP",
        cipherType: "Custom",
        hint: "The keyword 'KEY' repeats: K-E-Y-K-E-Y...\nShift each letter backward by the keyword letter's position (A=0, B=1, etc.).\nK=10, E=4, Y=24. Apply these shifts in sequence.",
      },
      correctExplanation: "Using keyword 'KEY' (K=10, E=4, Y=24): R-10=H, I-4=E, J-24=L, V-10=L → 'MEET'. V-4=R, N-24=T → 'AT'. X-10=N, M-4=I, V-24=X, Z-10=P, F-4=B, V-24=X, M-10=C → 'MIDNIGHT'.",
      incorrectExplanation: "Vigenère uses a keyword to determine the shift for each letter. Align the keyword ('KEY') repeatedly under the ciphertext, then shift each letter backward by the keyword letter's position (A=0, B=1, ...).",
    },
    {
      type: "cipher",
      category: "puzzles",
    ...
    },
    {
      ...
      question: "Francis Bacon's biliteral cipher uses A/B patterns to encode letters. Decode this (B = B, A = A):",
      correctAnswer: "bacon cipher",
      acceptedAnswers: ["bacon cipher"],
      xpReward: 100,
      cipherData: {
        encodedMessage: "BAAAA AABBB AABAA AAAAA ABAAA AABAA AABAB BAABA AABAA ABABB",
        cipherType: "Custom",
        hint: "Each 5-letter group represents one letter.\nAAAAA = A, AAAAB = B, AAABA = C... but in Bacon's cipher, I/J and U/V share codes.\nThe groups map to: B=1, A=0.",
      },
      correctExplanation: "Bacon's cipher: BAAAA=1→B, AABBB=7→A, AABAA=4→C, AAAAA=0→O, ABAAA=8→N, AABAA=4→C, AABAB=5→I, BAABA=9→P, AABAA=4→C, ABABB=10→H, AABBB=7→E, AABAB=5→R → 'bacon cipher'.",
      incorrectExplanation: "Bacon's biliteral cipher uses groups of 5 symbols, each representing a letter via a fixed binary mapping. Treat B=1 and A=0, convert each 5-bit group to its letter position (A=0, B=1, etc.).",
    },
    {
      type: "cipher",
      category: "puzzles",
